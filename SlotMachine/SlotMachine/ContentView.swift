...
//  SlotMachine
//
//  Created by Gaurav Semwal on 03/03/25.
//
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .center, spacing: 80) {
                ...
                Button {
                    self.numbers[0] = Int.random(in: 0..<symbols.count)
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                ...
                case .failure:
                    return Alert(title: Text("Oooopppssss!"), message: Text("Better luck next time"), dismissButton: .cancel())
                }
            }
        }
    }
